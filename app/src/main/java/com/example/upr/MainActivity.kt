...
import com.example.upr.act.EditAdsAct
import com.example.upr.databinding.ActivityMainBinding
import com.example.upr.dialoghelper.DialogConst
import com.example.upr.dialoghelper.DialogHelper
import com.example.upr.dialoghelper.GoogleAccConst
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    private fun init()
    {
        ...
        var toggle = ActionBarDrawerToggle(this, rootElement.drawerLayout,rootElement.mainContent.toolbar,
            R.string.open,
            R.string.close
        )
